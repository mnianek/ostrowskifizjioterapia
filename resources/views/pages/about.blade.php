        ...
        <section class="mx-auto max-w-7xl px-4 pb-14 sm:px-6 lg:px-8 lg:pb-18">
            <div class="grid gap-4 lg:grid-cols-2">
                <article class="reveal surface-glass p-7 sm:p-8" data-reveal>
                    <p class="text-xs font-semibold uppercase tracking-[0.22em] text-ink/60 dark:text-paper/60">Jak pracuję</p>
                ...
                <article class="reveal surface-glass p-7 sm:p-8" data-reveal>
                    <p class="text-xs font-semibold uppercase tracking-[0.22em] text-ink/60 dark:text-paper/60">Z kim pracuję</p>
        ...
        <section class="mx-auto max-w-7xl px-4 pb-14 sm:px-6 lg:px-8 lg:pb-20">
            <div class="reveal surface-ink relative overflow-hidden p-8 sm:p-10" data-reveal>
                ...
                <div class="mt-8 flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('posts.index') }}" class="btn border border-paper/35 text-paper hover:bg-paper/10">
                        Zobacz artykuły
                    </a>
                </div>
            </div>
